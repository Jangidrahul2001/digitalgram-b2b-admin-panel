        ...
        <div className="max-w-full mx-auto print:shadow-none print:p-0">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start gap-6 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <h1 className="text-lg font-bold text-slate-900 tracking-tight leading-none uppercase">PAYNODE</h1>
            ...
            <div className="text-left sm:text-right w-full sm:w-auto">
              <span className="text-[9px] font-bold text-slate-300 uppercase tracking-[0.25em] block mb-2">Audit Hash</span>
          ...
          <div className="relative mb-8 overflow-hidden rounded-[2rem] bg-white border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] p-6">
            ...
            <div className="grid grid-cols-2 gap-8 relative z-10">
              <div className="text-left">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1">Settlement Amount</span>
                <div className="flex items-baseline gap-1.5">
                  <span className="text-3xl font-bold text-slate-900 tracking-tighter tabular-nums">{data.amount}</span>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">INR</span>
                </div>
              </div>
              <div className="text-left">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1">Final Status</span>
                <div className="flex items-center gap-2.5 mt-1">
                  <div className={cn(
                    "px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider flex items-center gap-2",
          ...
          <div className="mb-8">
            ...
            <div className="mt-4 p-4.5 bg-slate-50 border border-slate-100/80 rounded-2xl flex items-start gap-4">
              ...
              <div className="text-left pt-0.5">
                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest block mb-1">System Audit Remarks</span>
          ...
          <div className="pt-8 border-t border-slate-100 border-dashed flex justify-between items-end gap-6">
            <div className="text-left flex-1">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[11px] font-bold text-slate-800 tracking-tight">Verified Protocol v4.2</span>
              </div>
            ...
            <div className="flex flex-col items-center gap-2 group">
              ...
              <span className="text-[7px] font-bold text-slate-300 uppercase tracking-[0.2em]">Audit Scan</span>
            </div>
          </div>
        </div>
      </div>
