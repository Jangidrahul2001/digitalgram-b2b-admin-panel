      ...
      {isOpen && (
        <div className="fixed inset-0 z-9999 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-[95%] lg:max-w-7xl bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200 max-h-[90vh] flex flex-col"
          >
            {isLoading ? (
              ...
              <>
                <div className="flex items-center justify-between p-6 border-b border-slate-50 bg-white flex-shrink-0">
